...
@section('content')
    <div class="mt-3 mb-3">
        ...
        <div class="mt-4">
            <form action="{{route('admin.articles.store')}}" class="w-50" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Время прочтения</label>
                    <input type="text" class="form-control" name="time" id="exampleFormControlInput1"
                           placeholder="Время">
                </div>
                <div class="mb-3">
